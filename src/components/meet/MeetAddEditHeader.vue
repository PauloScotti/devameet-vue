...
<template>
    <div class="container-meet-user-header">
        <div>
            ...
            <input v-model="model" type="text" placeholder="Digite o nome da sua reunião" />
        </div>
        ...
        <div class="wrapper">
            <div class="content">
                <div class="container">
                    ...
                    <div>
                        <div class="color" v-for="color in colors" :style="{backgroundColor: color}" :key="color" :class="color === selected ? 'selected' : ''" @click="selected = color" />
                    </div>
                </div>
                <div class="actions">
